...
namespace WorkerBindingSamples
{
    ...
    {
        private readonly ILogger<EventGridSample> _logger;

        public EventGridSample(ILogger<EventGridSample> logger)
        {
            _logger = logger;
        }
        ...
        public void CloudEventFunction(
        ...
        public void CloudEventBatchFunction(
            [EventGridTrigger(IsBatched = true)] CloudEvent[] cloudEvents)
        {
